...
export default function About({metaData}) {
  return (
    ...
    <div className='h-900px h-md-400px h-lg-600px h-xl-900px container-fluid p-0 my-2 m-0 row justify-content-center justify-content-md-between'>
      <ImageComponent className='img-fluid d-block col-12 col-md-7 p-0 cover-image-shadowed mb-2 mb-md-0' src={decoracion} alt="spa-5" hash={'LFGkg;4TT}4n00o}V?X8?HMw-;M|'} /* width={"58%"} height={} */ />
      {/* <img loading='lazy' className='img-fluid col-12 col-md-7 p-0 cover-image-shadowed mb-2 mb-md-0' src={decoracion} alt="spa-5" /> */}
      <ImageComponent className='img-fluid d-block col-12 col-md-40 p-0 cover-image-shadowed' src={ventana} alt="spa-6" hash={'U7Bp96R50KyC-:oL9Eo#00tQ~VMyDiWW?cVs'} />
    ...
    <div className="container-fluid p-0 py-lg-50px d-flex flex-column align-items-center">
      ...
      <img loading='lazy' alt='barra de la cheminée' className='img-fluid col-12 p-0 cover-image-shadowed mt-4 mb-md-0' src={barra} />
    </div>

    <div className="top-separator min-height-600 min-height-md-700 p-0 py-lg-50px d-flex flex-column align-items-center">
      ...
      <img loading='lazy' className='img-fluid min-height-300 col-12 p-0 cover-image-shadowed mt-3 mb-5 mb-md-0' alt='la cheminee' src={banner} />
    </div>
