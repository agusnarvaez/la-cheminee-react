...
export default function About({metaData}) {
  return (
    ...
    <div className='introduction-images container-fluid p-0 my-2 m-0 row justify-content-center justify-content-md-between'>
      <img className='img-fluid col-12 col-md-7 p-0 cover-image-shadowed mb-2 mb-md-0' src={decoracion} alt="spa-5" />
      <img className='img-fluid col-12 col-md-40 p-0 cover-image-shadowed' src={ventana} alt="spa-6" />
    </div>
    ...
    <div className="container-fluid p-0 py-0 py-lg-5 d-flex flex-column align-items-center my-5">
      ...
      <img alt='barra de la cheminée' className='img-fluid col-12 p-0 cover-image-shadowed mt-5 mb-md-0' src={barra} />
    </div>
    ...
    <div className="top-separator min-height-600 min-height-md-700 p-0 pt-4 py-lg-5 d-flex flex-column align-items-center">
      ...
      <img className='img-fluid min-height-300 col-12 p-0 cover-image-shadowed mt-3 mb-md-0' alt='la cheminee' src={banner} />
    </div>
