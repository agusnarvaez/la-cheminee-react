...
export default function HomeInfo() {
  return (
    <section className="container-fluid col-12 row m-0 pb-5 pb-lg-4 border-bottom justify-content-center">
      ...
      <div className="container-fluid col-12 col-lg-6 row m-0 my-lg-5 p-0 py-3 align-items-start flex-column align-items-center justify-content-start">
        ...
        <p className='p-0 px-lg-5 m-0 texto-verde-la-cheminee text-center fs-6'>Dentro de la instalación se podrá hacer uso de las 2 duchas escocesas, sauna seco, sauna húmedo, sala de relax y sala para masajes, con acceso a piscina con jacuzzi cubiertos y climatizados para ser usados todo el año. Wi fi en todas las áreas del hotel, petit café bar , salón desayunador. </p>
      </div>
