  ...
  return (
    <section className="container-fluid col-12 row m-0 border-bottom">
      ...
      <div className="container-fluid col-12 col-lg-6 row m-0 my-lg-5 p-0 py-3 justify-content-center homeInfoContent">
        <img src={woodsIcon} alt="Icono" className='col-2 col-md-1 col-lg-1 px-lg-0 mb-3 img-fluid' />
      ...
      <div className="container-fluid col-12 col-lg-6 row m-0 my-lg-5 p-0 py-3 justify-content-center">
        <img src={careIcon} alt="Icono" className='col-2 col-md-1 col-lg-1 px-lg-1 mb-3 img-fluid' />
