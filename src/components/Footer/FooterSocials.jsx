...
export default function FooterSocials() {
  const liStyle = 'container-fluid p-0 m-0 my-2 m-lg-0 col-2 col-md-1 col-lg-4'
  ...
  return (
    <section className="container-fluid flex-column justify-content-start align-items-start p-0 m-0 py-3 p-lg-0 row col-12 col-lg-2">
        ...
        <h2 className="fs-5 d-block fw-bold col-12 border-lg-0 p-0" style={{ height: '20px' }}>Redes Sociales</h2>
