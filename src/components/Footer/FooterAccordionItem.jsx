    ...
    return (
        ...
        <div className="accordion-item border-top border-0 bg-green-la-cheminee">
            <h2 className="accordion-header bg-green-la-cheminee border-0">
                <button className="accordion-button fs-1rem shadow-none p-0 py-3 collapsed fw-bold bg-green-la-cheminee text-white border-0" type="button" data-bs-toggle="collapse"
